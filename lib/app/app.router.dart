...
import 'package:soro_soke/models/chat_model.dart' as _i18;
import 'package:soro_soke/ui/views/ai_chat/ai_chat_view.dart' as _i16;
...
import 'package:soro_soke/ui/views/edit_profile/edit_profile_view.dart' as _i15;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i16.AiChatView: (data) {
      return _i17.MaterialPageRoute<dynamic>(
        builder: (context) => const _i16.AiChatView(),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i19.NavigationService {
  ...
  Future<dynamic> navigateToChatView({
    required _i18.ChatModel friend,
    _i17.Key? key,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
  ...
  Future<dynamic> navigateToAiChatView([
    ...
    return navigateTo<dynamic>(Routes.aiChatView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithAiChatView([
    ...
    return replaceWith<dynamic>(Routes.aiChatView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
